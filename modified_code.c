...
//   y_acc_string, z_acc_string); Serial.println(bufferAcc);*/
// }
...
//       Serial.println(MybloodPressureData.diastolic);
//       Serial.print("Systolic: ");
//       Serial.println(MybloodPressureData.systolic);
//       Serial.print("Pulse/min: ");
//       Serial.println(MybloodPressureData.pulse);
