...
void manage_input_data()
{
    ...
    mysignalData.temperature[0] = (mysignalData.temperature[0] + mysignalData.temperature[1] + mysignalData.temperature[2] + mysignalData.temperature[3] + mysignalData.temperature[4]) / 5;
    mysignalData.conductance[0] = (mysignalData.conductance[0] + mysignalData.conductance[1] + mysignalData.conductance[2] + mysignalData.conductance[3] + mysignalData.conductance[4]) / 5;
    mysignalData.resistance[0] = (mysignalData.resistance[0] + mysignalData.resistance[1] + mysignalData.resistance[2] + mysignalData.resistance[3] + mysignalData.resistance[4]) / 5;
    mysignalData.resistive_voltages[0] = (mysignalData.resistive_voltages[0] + mysignalData.resistive_voltages[1] + mysignalData.resistive_voltages[2] + mysignalData.resistive_voltages[3] + mysignalData.resistive_voltages[4]) / 5;
    mysignalData.snore_voltages[0] = (mysignalData.snore_voltages[0] + mysignalData.snore_voltages[1] + mysignalData.snore_voltages[2] + mysignalData.snore_voltages[3] + mysignalData.snore_voltages[4]) / 5;
